...
excelFile.addEventListener('change', async function () {
    ...
    try {
        ...
        const response = await fetch('/api/upload-qozoq', {
            method: 'POST',
            headers: {
