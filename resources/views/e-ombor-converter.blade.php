...
<body>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <div class="text-center mb-4">
                                        ...
                                        <h2 class="page-title" style="font-size: 2.5rem;"> E Ombor fayllarini Formatlash
                                        </h2>
                                        <p class="page-subtitle">E ombor fayllarini zanjeerga yuklash uchun tayyorlash
                                        </p>
                                    </div>
    ...
    <script>
        ...
        `;
            ...
            btnText.innerHTML =
                `${files.length} ta faylni formatlash va yuklab olish`;
        }
        ...
        document
            ...
            .addEventListener('submit', async function (e) {
                ...
                btnText.innerHTML =
                    '<i class="fas fa-spinner fa-spin me-2"></i> Formatlanmoqda...';
