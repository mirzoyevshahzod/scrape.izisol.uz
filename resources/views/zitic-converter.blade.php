                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <div class="text-center mb-4">
                                        ...
                                        <h2 class="page-title" style="font-size: 2.5rem;">Zitic Converter</h2>
                                            ...
                                            <form id="scrapeForm" enctype="multipart/form-data">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <select name="merge5" id="merge5" class="form-select form-select-lg" >
                                                            <option value="">-- Zitic Filelar --</option>
                                                        </select>
                                                    </div>
...
document.getElementById('scrapeForm').addEventListener('submit', async (e) => {
    ...
    const file = document.getElementById('merge5').value;

    if (!file) {
        Swal.fire('Xatolik', 'Faylni tanlang!', 'warning');
        return;
    }

    const response = await fetch('/api/zitic/convert', {
        method: 'POST',
        headers: {
    ...
    if (!response.ok) {
        Swal.fire('Xatolik', 'Konvertatsiya amalga oshmadi.', 'error');
        return;
    }
