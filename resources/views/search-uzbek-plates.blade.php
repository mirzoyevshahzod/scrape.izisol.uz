...
<head>
    ...
    <title>Filter Uzbek Car Number Files</title>
            ...
            <div class="col-12">
                <div class="main-content">
                    <h1 class="header-title">
                        ...
                        O'zbekiston davlat raqamlarini Filterlash
                    </h1>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <div class="text-center mb-4">
                                        ...
                                        <h2 class="page-title" style="font-size: 2.5rem;"> O'zbekiston davlat raqamlarini Filterlash</h2>
                                        <p class="page-subtitle">O'zbekiston davlat raqamlarini zanjeerga yuklash uchun tayyorlash</p>
                                    </div>
...
document.getElementById('uploadForm').addEventListener('submit', async function(e){
    ...
    btnText.innerHTML =
        '<span class="spinner-border spinner-border-sm me-2"></span>Yuklanmoqda...';
    ...
    const response = await fetch('/api/filter-uz-plates', {
        method: 'POST',
        body: formData
    });
    ...
    let filename = 'uzbek_plates.xlsx';
    ...
    Swal.fire(
        'Tayyor!',
        'O\'zbekiston davlat raqamlari muvaffaqiyatli ajratildi.',
        'success'
    );
});
</script>
